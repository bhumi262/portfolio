                  ...
                  <div className="col-md-12 col-sm-12">
                    <div className="home-text wow fadeIn text-center">
                      <h1 className="cd-headline clip is-full-width">
                        ...
                        >
                          <b className="is-hidden">Bhumika singh</b>
                      ...
                      <div className="about-social-icon text-center">
                        <ul className="about-social">
                          <li className="wow fadeIn" data-wow-delay=".4s">
                            <a
                              href="https://www.linkedin.com/in/bhumika-singh-4b864a206/"
                              target="newtab"
                            >
                              <i
                          ...
                          <li className="wow fadeIn" data-wow-delay=".2s">
                            <a
                              href="https://github.com/bhumi262"
                              target="newtab"
                            >
                              <i
                          ...
                          {/* <li className="wow fadeIn" data-wow-delay=".6s">
                            <a
                              href="https://www.instagram.com/Bhumika singhjana01/"
                              target="newtab"
                            >
                              <i
                          ...
                          {/* <li className="wow fadeIn" data-wow-delay=".8s">
                            <a
                              href="https://twitter.com/Bhumika singhjana01"
                              target="newtab"
                            >
                              <i
                          ...
                          {/* <li className="wow fadeIn" data-wow-delay="1s">
                            <a
                              href="https://dev.to/Bhumika singhjana"
                              target="newtab"
                            >
                  ...
                  <div className="col-md-8 col-sm-6 col-xs-12 about-col">
                    <div className="about-details wow fadeIn">
                      <div className="main-title left-title text-left wow fadeIn">
                        <h3>Hello! This is Bhumika singh</h3>
                  ...
                  <div className="col-md-4 col-sm-4">
                    <div className="resume-details" data-wow-delay=".2s">
                      ...
                      <div className="resume-main">
                        ...
                        <div className="underline2"></div>
                        <p>
                          Completed my school life from Vidya Mandir Public
                          School, Faridabad, Haryana, India.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-md-6 col-sm-12">
                    <div className="exp-details" data-wow-delay=".2s">
                      ...
                      <div className="exp-main">
                        ...
                        <h3>
                          <a
                            href="https://davim.ac.in/placementlatest.php"
                            target="_blank"
                            rel="noopener noreferrer"
                            style={{ color: "#4d4d4d" }}
                          >
                        ...
                        <div className="underline2"></div>
                        <p>
                          I Completed my Master's Degree from DAVIM
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-6 col-sm-12">
                    <div className="exp-details" data-wow-delay=".3s">
                      ...
                      <div className="exp-main">
                        ...
                        <div className="underline2"></div>
                        <p>
                          At TapMo, I was working as a Web Developer
                            ...
                            >
                              ...
                              <div className="carousel-inner">
                                <div className="active item">
                                  <blockquote>
                                    <p>
                                      “Bhumika singh was a real pleasure to work with
                                ...
                                <div className="item">
                                  <blockquote>
                                    <p>
                                      “Bhumika singh's a clear communicator with the
                                ...
                                <div className="item">
                                  <blockquote>
                                    <p>
                                      “Bhumika singh has done a fantastic job overall.
                  ...
                  <div className="row">
                    <div className="col-md-4 col-sm-6">
                      <div className="blog-main">
                        <a
                          href="https://dev.to/Bhumika singh/what-is-hooks-in-react-js-41l2"
                          target="_blank"
                          rel="noopener noreferrer"
                        >
                          <img
                        ...
                        <div className="blog-head">
                          <a
                            href="https://dev.to/Bhumika singhjana/what-is-hooks-in-react-js-41l2"
                            target="_blank"
                            rel="noopener noreferrer"
                    ...
                    <div className="col-md-4 col-sm-6">
                      <div className="blog-main">
                        <a
                          href="https://dev.to/Bhumika singhjana/the-importance-of-ui-ux-software-engineering-1n0n"
                          target="_blank"
                          rel="noopener noreferrer"
                        >
                          <img
                    ...
                    <div className="col-md-4 col-sm-6">
                      <div className="blog-main">
                        <a
                          href="https://dev.to/Bhumika singhjana/form-example-in-laravel-8-45oc"
                          target="_blank"
                          rel="noopener noreferrer"
                        >
                          <img
                  ...
                  <div className="row contact-info-row text-center wow fadeIn">
                    ...
                    <div className="col-md-3 col-sm-6 contact-colamn">
                      <div className="contact-col-info" data-wow-delay=".4s">
                        ...
                        <h3>Email</h3>
                        <a
                          href="mailto:contact.singhbhumi2000@gmail.com"
                          style={{
                            color: "black",
                            textDecoration: "none",
                            fontSize: "17px",
                    ...
                    {/* <div className="col-md-3 col-sm-6 contact-colamn">
                      <div className="contact-col-info" data-wow-delay=".6s">
                        ...
                        ></i>
                        <h3>Portfolio</h3>
                        <p>https://Bhumika singhjana.github.io/</p>
                      </div>
                    </div> */}
                  </div>
                </div>
